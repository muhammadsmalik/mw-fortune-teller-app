...
// ── LAYER 3: reject output with literal unfilled template placeholders (e.g. "[company]"). ──
// Subjective marketing-fluff blocklisting was removed — too brittle: an incomplete list that
// still missed most fluff while false-rejecting specific, grounded bullets ("unlocks
// programmatic demand from The Trade Desk"). Grounding (Layer 2) is the real quality gate.
